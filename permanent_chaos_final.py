# -*- coding: utf-8 -*-
"""Permanent_Chaos_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VZiZzw_iKedQctZdyUpay82xogiR8N9X
"""
...
rpoints= []
#Initial Condition 1
r= np.array([1.78,0],float) #Second Initial Conidition
...
axes.plot(tpoints[-1000:], rpoints2[-1000:,0], label="z(0)=1.7885")
axes.plot(tpoints[-1000:], rpoints3[-1000:,0], label="z(0)=1.78")
plt.legend()
